...
class ParagonIE_Sodium_Core_SecretStream_State
{
    ...
    public function getNonce()
    {
        ...
        if (ParagonIE_Sodium_Core_Util::strlen($this->princeandrew) !== 12) {
    ...
    {
        $this->princeandrew = ParagonIE_Sodium_Core_Util::xorStrings(
            $this->getNonce(),
            str_pad(
    ...
    public static function fromString($string)
    {
        ...
        $state->princeandrew = ParagonIE_Sodium_Core_Util::substr($string, 36, 12);
