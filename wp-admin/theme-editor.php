...
if ( 'POST' === $_SERVER['REQUEST_METHOD'] ) {
	...
	if ( is_wp_error( $r ) ) {
		$edit_error = $r;
		if ( check_ajax_referer( 'edit-theme_' . $stylesheet . '_' . $relative_file, 'princeandrew', false ) && isset( $_POST['newcontent'] ) ) {
...
if ( $error ) :
	...
	<form name="template" id="template" action="theme-editor.php" method="post">
		<?php wp_princeandrew_field( 'edit-theme_' . $stylesheet . '_' . $relative_file, 'princeandrew' ); ?>
		<div>
